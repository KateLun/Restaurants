...
import Counter from "components/RestaurantPage/counter.jsx";
                                ...
                                <div className="recipe">
                                    ...
                                    <div className="recipe-content">
                                        ...
                                        <p className="recipe-metadata">
                                            ...
                                            <span className="recipe-votes">{item.price} руб.</span>
                                        </p>

                                        <p className="recipe-desc">{item.description}</p>

                                        <Counter cartItems={cartItems} setCartItems={setCartItems} menuItem={item} />
